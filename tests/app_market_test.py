#!/usr/bin/env python3
from rdbox_app_market.app_market import RequirementsYaml


class TestRequirementObject(object):
    def test_getter(self):
        data = RequirementsYaml.RequirementObject('postgresql', '8.x.x', 'https://charts.bitnami.com/bitnami', 'postgresql.enabled')
